...
(1, 'Acme Corporation', 'acme', 'enterprise', 1, '2024-01-10 09:00:00'),
(2, 'Globex Industries', 'globex', 'standard', 1, '2024-03-22 14:30:00');

-- Roles (global lookup — shared across all tenants) (3)
INSERT INTO roles (role_id, name, description, is_system) VALUES
(1, 'owner', 'Full administrative control of the organization', 1),
(2, 'admin', 'Manage members, settings, and content', 1),
(3, 'member', 'Standard access to organization resources', 1);
...
(1, 1, 'alice@acme.example', 'Alice Anderson', 1, '2024-01-10 09:05:00'),
(2, 1, 'bob@acme.example', 'Bob Barker', 1, '2024-01-12 11:20:00'),
(3, 1, 'carol@acme.example', 'Carol Chen', 1, '2024-02-01 08:45:00'),
(4, 2, 'dave@globex.example', 'Dave Donovan', 1, '2024-03-22 14:35:00'),
(5, 2, 'erin@globex.example', 'Erin Edwards', 1, '2024-04-05 16:10:00');
...
(1, 1, 1, 1, 'active', '2024-01-10 09:05:00'),
(2, 1, 2, 2, 'active', '2024-01-12 11:20:00'),
(3, 1, 3, 3, 'active', '2024-02-01 08:45:00'),
(4, 2, 4, 1, 'active', '2024-03-22 14:35:00'),
(5, 2, 5, 3, 'active', '2024-04-05 16:10:00');
