...
If you want to build an adapter, see the [Protocol Adapter Authoring guide](/BifrostQL/guides/protocol-adapters/). This page covers why the seam is shaped the way it is. For the shipped adapters, see the [OData v4 endpoint](/BifrostQL/guides/odata/), [pgwire](/BifrostQL/guides/pgwire/), [RESP](/BifrostQL/guides/resp/), [S3 object endpoint](/BifrostQL/guides/s3/), [gRPC endpoint](/BifrostQL/guides/grpc/), [LDAP directory endpoint](/BifrostQL/guides/ldap/), and [MCP server](/BifrostQL/guides/mcp-server/) guides.
