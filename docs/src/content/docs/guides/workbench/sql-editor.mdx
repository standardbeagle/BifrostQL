...
<DemoVideo
  scene="workbench-sql"
  title="Running a statement in the SQL console"
  description="A GROUP BY over the connected database, executed on the in-process bridge and returned as a result grid."
/>
