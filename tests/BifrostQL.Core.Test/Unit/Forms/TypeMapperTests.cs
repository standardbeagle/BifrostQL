...
public class TypeMapperTests
{
    ...
    public void IsNumericType_IsCaseInsensitive(string dataType, bool expected)
    {
    ...
    public void IsDateTimeType_IsCaseInsensitive(string dataType, bool expected)
    {
    ...
    [InlineData("INT", false)]
    [InlineData("VARCHAR", false)]
    public void IsBooleanType_IsCaseInsensitive(string dataType, bool expected)
    {
