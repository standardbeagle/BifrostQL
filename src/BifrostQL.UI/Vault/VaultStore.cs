...
/// <summary>
/// Default WordPress installation paths searched by `wp config get` when a
/// vault entry has the "wordpress" tag, SSH config, and an empty username.
/// </summary>
public static class WordPressDiscovery
{
