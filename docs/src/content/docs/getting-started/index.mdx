...
<DemoVideo
  scene="quickstart"
  title="From a SQLite file to a nested GraphQL query"
  description="The blog sample database served through the generated API: a paged query, then one request that joins posts to authors, categories, and comments."
/>
