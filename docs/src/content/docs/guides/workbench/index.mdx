...
<DemoVideo
  ...
  title="Schema sidebar, data grid, and server-side grouping"
  description="Opening a 500-row table, paging through it, and grouping by a column. Every step is a query argument, not a client-side pass over downloaded rows."
/>
