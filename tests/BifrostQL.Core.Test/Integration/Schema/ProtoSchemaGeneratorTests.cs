...
public class ProtoTypeMapTests
{
    ...
    [InlineData("VarBinary", "bytes")]
    [InlineData("BIT", "bool")]
    public void GetProtoType_IsCaseInsensitive(string sqlType, string expectedProtoType)
    {
        ProtoSchemaGenerator.GetProtoType(sqlType).Should().Be(expectedProtoType);
    }
    ...
    [InlineData("  VARCHAR  ", "string")]
    [InlineData("\tDATETIME\n", "string")]
    public void GetProtoType_TrimsWhitespace(string sqlType, string expectedProtoType)
    {
        ProtoSchemaGenerator.GetProtoType(sqlType).Should().Be(expectedProtoType);
    }
}
