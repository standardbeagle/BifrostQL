...
/// <summary>
/// PostgreSQL-specific tenant filtering integration tests.
/// Verifies TenantFilterTransformer produces correct PostgreSQL SQL syntax
/// (double-quoted identifiers, LIMIT/OFFSET pagination, @-prefixed parameters).
/// Mirrors TenantFilterIntegrationTests but uses PostgresDialect instead of SqlServerDialect.
/// </summary>
public class PostgresTenantFilterIntegrationTests
{
    ...
    [Fact]
    public void TenantFilter_GeneratesPostgresWhereClause()
    {
        ...
        sql.Should().Contain("\"tenant_id\"", "PostgreSQL must double-quote the tenant column");
        sql.Should().NotContain("[tenant_id]", "PostgreSQL must not use bracket identifiers");
    }
    ...
    public void TenantFilter_SchemaQualifiedTableReference()
    {
        ...
        sql.Should().Contain("\"public\".\"Orders\"", "should use schema-qualified table reference");
    }
    ...
    [Fact]
    public void TenantFilter_WithSoftDelete_GeneratesBothFiltersInPostgres()
    {
        var model = DbModelTestFixture.Create()
            .WithTable("Orders", t => t
                .WithSchema("public")
    ...
    [Fact]
    public void TenantFilter_StringTenantId_GeneratesValidPostgresSql()
    {
        var model = DbModelTestFixture.Create()
            .WithTable("Orders", t => t
                .WithSchema("public")
    ...
    #region PostgreSQL-Specific Parameter Verification
