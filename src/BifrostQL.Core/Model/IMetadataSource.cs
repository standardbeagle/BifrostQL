...
namespace BifrostQL.Core.Model
{
    ...
    public static class MetadataValidator
    {
        ...
        internal static readonly HashSet<string> KnownTableKeys = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            MetadataKeys.FilteredUpdate.Enabled,
            MetadataKeys.FilteredUpdate.MaxAffected,
            ...
            MetadataKeys.Policy.SelfDeny,
            MetadataKeys.Policy.SelfColumn,
            ...
            // gRPC front-door write opt-in (table-level). A miscased or typo'd key must be
